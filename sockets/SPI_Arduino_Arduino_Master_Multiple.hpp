...
protected:
    ...
    // Constructor
    SPI_Arduino_Arduino_Master_Multiple(int* ss_pins, uint8_t ss_pins_count) : BroadcastSocket() {
...
public:
    ...
    static SPI_Arduino_Arduino_Master_Multiple& instance(int* ss_pins, uint8_t ss_pins_count) {
        static SPI_Arduino_Arduino_Master_Multiple instance(ss_pins, ss_pins_count);
    ...
    const char* class_name() const override { return "SPI_Arduino_x2_Master_M"; }

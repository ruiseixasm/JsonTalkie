...
*/
#ifndef BASIC_SPI_ESP_ARDUINO_MASTER_HPP
#define BASIC_SPI_ESP_ARDUINO_MASTER_HPP
...
class S_Basic_SPI_ESP_Arduino_Master : public BroadcastSocket {
public:

	// The Socket class description shouldn't be greater than 35 chars
	// {"m":7,"f":"","s":3,"b":1,"t":"","i":58485,"0":1,"1":"","2":11,"c":11266} <-- 128 - (73 + 2*10) = 35
    const char* class_description() const override { return "Basic_SPI_ESP_Arduino_Master"; }
...
protected:
    ...
    // Constructor
    S_Basic_SPI_ESP_Arduino_Master(int* ss_pins, uint8_t ss_pins_count) : BroadcastSocket() {
...
public:
    ...
    static S_Basic_SPI_ESP_Arduino_Master& instance(int* ss_pins, uint8_t ss_pins_count) {
        static S_Basic_SPI_ESP_Arduino_Master instance(ss_pins, ss_pins_count);
...
#endif // BASIC_SPI_ESP_ARDUINO_MASTER_HPP

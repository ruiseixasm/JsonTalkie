...
// #define BROADCAST_ETH_DEBUG
#define ENABLE_DIRECT_ADDRESSING


class BroadcastSocket_ETH : public BroadcastSocket {
private:
...
public:
    // Singleton accessor
    static BroadcastSocket_ETH& instance() {
        static BroadcastSocket_ETH instance;
        return instance;
    }
...
#endif // BROADCAST_SOCKET_ETH_HPP

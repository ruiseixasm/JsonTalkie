...
#define TALKIE_RECOVERY_TTL 300		///< The maximum time to live of the recoverable message
...
struct TalkieCodes {
    ...
    enum SystemValue : uint8_t {
        ...
        TALKIE_SYS_ERRORS     ///< Represents all Socket errors, misses, drops and fails
    };
